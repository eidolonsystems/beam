...
SET BUILD_ASPEN=
SET ASPEN_COMMIT="f4515b9acc3e7efd78039a5a2d75e6cfd8fdddfa"
IF NOT EXIST aspen (
...
IF NOT EXIST boost_1_72_0 (
  ...
  IF !ERRORLEVEL! LEQ 0 (
    ...
    tools\build\b2 !BJAM_PROCESSORS! --with-context context-impl=winfib --prefix="!ROOT!\boost_1_72_0" --build-type=complete address-model=32 toolset=msvc-14.2 link=static runtime-link=shared install
    POPD
  ) ELSE (
    SET EXIT_STATUS=1
  )
